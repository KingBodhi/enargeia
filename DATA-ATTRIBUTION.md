...
|---|---|---|
| [CelesTrak](https://celestrak.org/) | `commercial_clean` | Orbital elements; attribution requested. |
| [GeoNames](https://www.geonames.org/) | `commercial_clean` | CC BY 4.0; attribution required. |
