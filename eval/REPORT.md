...
| Probabilistic: total ≥ 5.0 → merge | 0.842 | 0.640 | 0.727 | 38 |
| Probabilistic: merge **or review** (≥ 1.0) | 0.653 | 0.980 | 0.784 | 75 |

Auto-merge precision is the safety number: a wrong merge silently corrupts the graph. Merge-or-review recall is the coverage number: a true match that reaches review is fixed by a human rather than duplicated. At the defaults 14.2% of pairs land in review.

Best merge threshold with precision ≥ 0.85 on this sample: **6.5** (P 0.912, R 0.620, F1 0.738). Best F1 regardless of precision: 0.786 at 3.0 (P 0.687, R 0.920).

## Threshold sweep (positive iff total ≥ t)

| t | P | R | F1 | TP | FP | FN |
|---|---|---|---|---|---|---|
| 0.0 | 0.653 | 0.980 | 0.784 | 49 | 26 | 1 |
| 0.5 | 0.653 | 0.980 | 0.784 | 49 | 26 | 1 |
| 1.0 | 0.653 | 0.980 | 0.784 | 49 | 26 | 1 |
| 1.5 | 0.649 | 0.960 | 0.774 | 48 | 26 | 2 |
| 2.0 | 0.667 | 0.920 | 0.773 | 46 | 23 | 4 |
| 2.5 | 0.687 | 0.920 | 0.786 | 46 | 21 | 4 |
| 3.0 | 0.687 | 0.920 | 0.786 | 46 | 21 | 4 |
| 3.5 | 0.684 | 0.780 | 0.729 | 39 | 18 | 11 |
| 4.0 | 0.673 | 0.740 | 0.705 | 37 | 18 | 13 |
| 4.5 | 0.685 | 0.740 | 0.712 | 37 | 17 | 13 |
| 5.0 | 0.842 | 0.640 | 0.727 | 32 | 6 | 18 |
| 5.5 | 0.886 | 0.620 | 0.729 | 31 | 4 | 19 |
| 6.0 | 0.886 | 0.620 | 0.729 | 31 | 4 | 19 |
| 6.5 | 0.912 | 0.620 | 0.738 | 31 | 3 | 19 |
